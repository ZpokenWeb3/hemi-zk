...
```bash
cargo run --bin rsp --release -- --lhs-block-number 18884864 --rhs-block-number 18884864 --rpc-url <RPC>
```
...
```bash
cargo run --bin rsp --release -- --lhs-block-number 18884864 --rhs-block-number 18884864 --chain-id <chain-id>
```
...
```bash
cargo run --bin rsp --release -- --lhs-block-number 18884864 --rhs-block-number 18884864 --chain-id <chain-id> --cache-dir /path/to/cache
```
...
```bash
cargo run --bin rsp --release -- --lhs-block-number 18884864 --rhs-block-number 18884864 --chain-id <chain-id> --prove --save-proof
```
...
```bash
cargo run --bin rsp --release --features cuda -- --lhs-block-number 18884864 --rhs-block-number 18884864 --chain-id <chain-id> --prove --save-proof
```
